namespace Araba.DAL.Migrations
{
    ...
    public partial class a1 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        YakitTurleriID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.YakitTurleri", t => t.YakitTurleriID, cascadeDelete: true)
                .Index(t => t.YakitTurleriID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Arabalar", "YakitTurleriID", "dbo.YakitTurleri");
            ...
            DropIndex("dbo.Arabalar", new[] { "YakitTurleriID" });
            DropTable("dbo.AspNetUserLogins");
            DropTable("dbo.AspNetUserClaims");
            DropTable("dbo.AspNetUsers");
            DropTable("dbo.AspNetUserRoles");
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.YakitTurleri");
            DropTable("dbo.Arabalar");
        }
    }
}
